...
##CCSA - Ci�ncias Econ�micas
##Introdu��o � Econometria
##Gilvando Gomes de Lima J�nior
...
grafico <- c('Gr�fico 1: IPCA Acumulado, 2002-2017','Gr�fico 2: Selic Acumulada, 2002-2017','Gr�fico 3: Pib Real, 2002-2017 em Milh�es de R$','Gr�fico 4: Expectativa Infla��o, 2002-2017','Gr�fico 5: Meta Infla��o, 2002-2017','Gr�fico 06: Taxa de Juros Real','Gr�fico 07: Hiato do Produto','Gr�fico 08: Desvio Infla��o')
titulo <- c('Histograma do IPCA acumulado 12 meses','Histograma da Selic Acumulada 12 meses','Histograma do Pib Real','Histograma da Expectativa Infla��o','Histograma da Meta de Infla��o','Histograma da Taxa Real de Juros','Histograma do Hiato do Produto','Histograma do Desvio da Infla��o')
med.ted <- c('�NDICE DE PRE�OS AO CONSUMIDOR AMPLO','TAXA DE JUROS SELIC','PRODUTO INTERNO BRUTO REAL','EXPECTATIVA DE INFLA��O','META DE INFLA��O','TAXA REAL DE JUROS','HIATO DO PRODUTO','DESVIO DA INFLA��O')
titulos <- c('M�dia','Mediana','M�nimo','M�ximo','Desvio Padr�o','Coeficiente de Varia��o')
Curtose <- c('Curtose')
...
for (x in d ){
   ...
   (options(scipen = 999))
   (hist(x, breaks="sturges", col="darkgreen", main= titulo[c(cont)], ylab="Frequ�ncia", labels = T))
...
par(mfrow=c(3,1))
plot(Grafico09, main="Gr�fico 11: PIB REAL, SELIC, IPCA", col="darkgreen")
Grafico10<-cbind(IPCA,EXPC,META)
par(mfrow=c(3,1))
plot(Grafico10, main="Gr�fico 12: IPCA, EXPC, META", col="darkgreen") 
Grafico11<-cbind(TXREAL,SELIC,IPCA)
par(mfrow=c(3,1))
plot(Grafico11, main="Gr�fico 12: TX REAL, SELIC, IPCA", col="darkgreen")

par(mfrow=c(1,1))
plot(PIBDF, type="l", col="blue", main="Gr�fico 12: Pib Real e Pib Potencial Real")
...
par(mfrow=c(1,1))
plot(HIATOC, col="darkgreen", type="l", main="Gr�fico 13: Ciclo")
grid(col="grey", lwd="1")

par(mfrow=c(1,1))
seasonplot(PIBDF)
plot(PIB, type="l", col="darkgreen", main="Gr�fico: Pib Real e Pib Nominal")
...
##Regress�o com o Hiato PIB Real Filtro HP
...
##Estimando Selic Estimada e Res�duo
...
par(mfrow=c(1,1))
plot(SELICESTIMADA, main = "Gr�fico 9: Selic e Selic Estimada", type="l", col="darkgreen", xlab="Ano", ylab="")
grid(col="grey", lwd="1")
options(scipen = 999)
...
par(mfrow=c(1,2))
plot(RESIDUO, main = "Gr�fico 10: Res�duo da Regress�o", type="l", col="darkgreen", xlab="Ano", ylab="")
grid(col="grey", lwd="1")
abline(h=mean(RESIDUO), col="red")
options(scipen = 999)
hist(RESIDUO, breaks="sturges", col="darkgreen", main= "Histograma do Res�duo da Regress�o", ylab="Frequ�ncia", labels = T)
...
par(mfrow=c(1,2))
plot(RESIDUODYN, main = "Gr�fico 13: Res�duo da Regress�o Corretiva", type="l", col="darkgreen", xlab="Ano", ylab="")
grid(col="grey", lwd="1")
abline(h=mean(RESIDUODYN), col="red")
options(scipen = 999)
hist(RESIDUODYN, breaks="sturges", col="darkgreen", main= "Histograma do Res�duo da Regress�o Corretiva", ylab="Frequ�ncia", labels = T)
